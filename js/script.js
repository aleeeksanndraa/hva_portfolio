  ...
  const PROJECTS = [
    {
      ...
      chapters: [
        ...
        { n: "CONCEPT", title: "Concept", text: "First idea: a slim metal card, wallet-sized, name engraved into brushed aluminium — understated, a bit like a debit card. Drawn in Figma as a card shape with a cut into one edge, doubling as a bottle opener.", media: [{ label: "FIG. 05 — CONCEPT SKETCH", kind: "tall", img: "assets/process-sketch-card-01.png" }, { label: "FIG. 06 — ALUMINIUM CARD SKETCH", kind: "tall", img: "assets/process-sketch-card-02.png" }] },
        { n: "SKETCHES", title: "Sketches", text: "The card outline, the bottle-opener notch and the lettering, all built as vectors in Figma before anything touched the laser cutter — the file the machine actually reads.", media: [{ label: "FIG. 07 — SKETCH & CUT PIECE", kind: "tall", img: "assets/process-sketch-vs-lasercut.png" }] },
        { n: "EXPERIMENTS", title: "Experiments", text: "No aluminium, so clear acrylic instead. First pass out of the laser cutter: the card with \"Sasha\" engraved into it, plus a set of separate 3D letters cut from the same sheet. Held up to the light, the offcuts looked exactly like jelly sweets.", media: [{ label: "FIG. 08 — ACRYLIC MATERIAL REFERENCE", kind: "small", img: "assets/moodboard-acrylic-sheets.png" }, { label: "FIG. 09 — FIRST LASER-CUT PIECE", kind: "small", img: "assets/process-first-lasercut-card.png" }, { label: "FIG. 10 — LOOSE ACRYLIC LETTERS", kind: "small", img: "assets/process-lasercut-letters.png" }] },
        { n: "ITERATIONS", title: "Iterations", text: "The jelly look changed the direction completely: from a slick metal card to a Y2K keychain. Raided my own nail kit for rhinestones and sparkles, bedazzled the acrylic card by hand, then built up the keychain with extra charms until it read as one deliberately messy, glamorous object.", media: [{ label: "FIG. 11 — Y2K KEYCHAIN REFERENCE", kind: "wide", img: "assets/moodboard-y2k-keychain-03.png" }, { label: "FIG. 12 — Y2K KEYCHAIN REFERENCE", kind: "wide", img: "assets/moodboard-y2k-keychain-poster.png" }] },
